          ...
          <div class="flex flex-col sm:flex-row sm:items-end gap-3 sm:gap-4">
            <div class="flex-1">
              ...
              <input
                ...
                type="email"
                disabled
                class="w-full px-4 py-3 bg-gray-100 border border-gray-200 rounded-lg text-gray-500 cursor-not-allowed text-sm sm:text-base"
              />
            </div>
            <button
              @click="showChangePassword = !showChangePassword"
              class="px-4 py-3 border border-gray-300 rounded-lg text-sm font-medium text-gray-700 hover:bg-gray-50 transition-colors flex items-center justify-center gap-2 whitespace-nowrap"
            >
