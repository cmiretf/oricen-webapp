  ...
  <Layout>
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      ...
      <div class="prose prose-lg max-w-3xl mx-auto mb-16">
        <h2 class="text-2xl font-bold text-gray-900 mb-4">Nuestra Filosofía</h2>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-12 mb-16">
        <div class="bg-blue-50 p-8 rounded-lg">
          <h3 class="text-2xl font-bold text-[#2B4C7E] mb-4">Nuestra Misión</h3>
        ...
        <div class="bg-green-50 p-8 rounded-lg">
          <h3 class="text-2xl font-bold text-[#2B4C7E] mb-4">Nuestra Visión</h3>
          <p class="text-gray-700">
      ...
      <div class="bg-gray-50 p-12 rounded-lg">
        <h2 class="text-2xl font-bold text-gray-900 mb-8">Nuestros Valores</h2>
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <h4 class="font-bold text-[#2B4C7E] mb-2">Excelencia</h4>
            <p class="text-gray-600">Ofrecemos los mejores servicios con estándares de calidad internacional</p>
          </div>
          <div>
            <h4 class="font-bold text-[#2B4C7E] mb-2">Integridad</h4>
            <p class="text-gray-600">Trabajamos con honestidad y ética en todas nuestras acciones</p>
          </div>
          <div>
            <h4 class="font-bold text-[#2B4C7E] mb-2">Compromiso</h4>
            <p class="text-gray-600">Nos dedicamos completamente al éxito y bienestar de nuestros clientes</p>
          </div>
        </div>
      </div>
    </div>
